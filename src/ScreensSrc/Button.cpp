...
//----------------------------------------
// Constructor - initialize shape, texture, font, and text
//----------------------------------------
...
//----------------------------------------
// Set custom texture to the button
//----------------------------------------
...
void Button::updateHover(const sf::RenderWindow& window)
{
    if (m_shape.getGlobalBounds().contains(sf::Vector2f(sf::Mouse::getPosition(window))))
    {
        ...
        color.a = 200; // reduce alpha for hover effect
        m_shape.setFillColor(color);
    }
    else
    {
...
//----------------------------------------
// Handle mouse click event and execute command
//----------------------------------------
...
//----------------------------------------
// Center the label inside the button shape
//----------------------------------------
