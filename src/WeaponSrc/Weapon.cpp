...
//-------------------------------------
Weapon::Weapon(const Constants::WeaponType type, const float shootingRange,
	const float damage, const float angle): m_type(type), m_shootingRange(shootingRange), m_damage(damage)
{
