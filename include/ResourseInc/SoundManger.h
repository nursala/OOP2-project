...
const std::unordered_map<Constants::SoundID, std::string> SoundFileMap = {
	  ...
	  {Constants::SoundID::BACKGROUNDMUSIC, "background_game_play.ogg"} , {Constants::SoundID::MENUMUSIC, "menu_music.ogg"}
	, {Constants::SoundID::MATCHMAKINGMUSIC, "matchmaking_music.ogg"}   , {Constants::SoundID::GAMEOVERSOUND, "gameover.ogg"}           
	, {Constants::SoundID::RIFLESOUND, "AK47.ogg"}                      , {Constants::SoundID::SHOTGUNSOUND, "shotgun_shot.ogg"}
	, {Constants::SoundID::PISTOLSOUND, "pistol_shot.ogg"}              , {Constants::SoundID::SNIPERSOUND, "sniper_shot.ogg"}
