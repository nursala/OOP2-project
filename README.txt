...
המשחק נבנה באמצעות ++C תוך שימוש בספריות SFML and Candle ו־Box2D, ושומר על עקרונות OOP, תבניות תכנון (Design Patterns), וקוד נקי ומודולרי.
---
...
std::vector
לאחסון אובייקטים מרובים כמו אויבים, קליעים ועוד.
...
שימוש ב־  Strategies and State Pattern לניהול התנהגות האויב (עומד, תוקף, עוקב).
...
הבדיקה כוללת פגיעה באויבים, שחקן
